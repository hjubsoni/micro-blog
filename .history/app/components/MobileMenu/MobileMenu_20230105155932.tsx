    ...
    >
      <DialogContent className="h-full flex flex-col  ">
        ...
        <nav className="absolute top-1/4 left-6 flex flex-col gap-6 w-3/4">
          <Link
            href="/"
            className=" flex gap-4 items-center text-text text-2xl animate-[wiggle_200ms_ease-out]"
          >
          ...
          <Link
            href="/"
            className="flex gap-4 items-center text-text text-2xl animate-[wiggle_800ms_ease-out]"
          >
